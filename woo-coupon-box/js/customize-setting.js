jQuery(document).ready(function ($) {
    ...
    api('woo_coupon_box_params[wcb_social_icons_tiktok_select]', function (value) {
        value.bind(function (newval) {
            jQuery('.woo_coupon_box_params-wcb_social_icons_tiktok_select label').removeClass('wcb-radio-icons-active');
            jQuery('.woo_coupon_box_params-wcb_social_icons_tiktok_select .' + newval).parent().addClass('wcb-radio-icons-active');
        })
    });
});