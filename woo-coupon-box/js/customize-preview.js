...
(function ($) {
	...
	//tiktok
	api('woo_coupon_box_params[wcb_social_icons_tiktok_url]', function (value) {
		value.bind(function (newval) {
			$('.wcb-tiktok-follow').attr('href', newval);
			if (newval) {
				$('.wcb-tiktok-follow').show();
			} else {
				$('.wcb-tiktok-follow').hide();
			}
		})
	});
	api('woo_coupon_box_params[wcb_social_icons_tiktok_select]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-tiktok-follow span').attr('class', 'wcb-social-icon ' + newval);
		})
	});
	api('woo_coupon_box_params[wcb_social_icons_tiktok_color]', function (value) {
		value.bind(function (newval) {
			jQuery('.wcb-tiktok-follow span').css({ 'color': newval });
		})
	});
